...
public interface ServiceApi {
    ...
    Call <DriverServerResponse> isDriverOnline(@Field("mobile") String mobile, @Field("is_driver_online") int is_driver_online, @Field("firebaseToken") String firebaseToken);
