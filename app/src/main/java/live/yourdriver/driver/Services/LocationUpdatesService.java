...
public class LocationUpdatesService extends Service {
    ...
    private static final String PACKAGE_NAME =
            "live.yourdriver.driver.services.locationupdatesforegroundservice";
...
//            stopSelf();
    ...
    public boolean onUnbind(Intent intent) {
        ...
        if (!mChangingConfiguration && UtilsGoogle.requestingLocationUpdates(this)) {
    ...
    public void requestLocationUpdates() {
        ...
        UtilsGoogle.setRequestingLocationUpdates(this, true);
        startService(new Intent(getApplicationContext(), LocationUpdatesService.class));
        try {
            mFusedLocationClient.requestLocationUpdates(mLocationRequest,
                    mLocationCallback, Looper.myLooper());
        } catch (SecurityException unlikely) {
            UtilsGoogle.setRequestingLocationUpdates(this, false);
    ...
    private Notification getNotification() {
        ...
        CharSequence text = UtilsGoogle.getLocationText(mLocation);
        ...
        PendingIntent activityPendingIntent = PendingIntent.getActivity(this, 0,
                new Intent(this, DriverActivity.class), 0);

        NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
//                .addAction(R.drawable.driver_final_icon, getString(R.string.launch_activity),
                .addAction(R.drawable.driver_final_icon, "Open App.",
...
//                .addAction(R.drawable.ic_cancel, getString(R.string.remove_location_updates),
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            builder.setChannelId(CHANNEL_ID).setSound(null); // Channel ID
        }
